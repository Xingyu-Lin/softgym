...
args.add_argument("--cem_traj_path", type=str, default='./data/traj/cloth_fold_cem_traj.pkl')
...
if __name__ == '__main__':
    ...
    cached_file = osp.join(cur_dir, 'cem_cloth_fold_init_states.pkl')
    env = ClothFoldEnv(
    ...
    if not args.replay:
        ...
        for action in action_traj:
            env.step(action)
        env.end_record(video_path=os.path.join(des_dir, 'cem_fold.gif'))
