...
class PourWaterPosControlEnv(FlexEnv):
    ...
    def reset(self):
        ...
        '''
        self.set_flex_state(self.init_state)
    ...
    def set_scene(self):
        ...
        self.glass_dix_z = 0.2 # glass width
        scene_params = np.array([x, y, z, self.dim_x, self.dim_y, self.dim_z, self.glass_dis_x, self.glass_dix_z])
    ...
    def create_glass(self):
        ...
        # floor
        halfEdge = np.array([self.glass_dis_x/2., self.border/2., self.glass_dix_z/2.])
    ...
    def move_glass(self, prev_states, x_curr, y_curr):
        ...
        10-14: previous quat 
        '''
        dis_x, dis_z = self.box_dis_x, self.box_dis_z
