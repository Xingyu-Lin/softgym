...
rm -rf $RELEASE_DIR
mkdir -p $RELEASE_DIR
rsync -aP --exclude=data --exclude=.git --exclude=__pychache__ --exclude=.gitignore  --exclude=.idea --exclude=.gitmodule --exclude=PyFlex --exclude=PyFlex_old --exclude=PyFlexRobotics ./ $RELEASE_DIR
cd $RELEASE_DIR
