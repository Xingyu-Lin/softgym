...
void exactinit()
{
  ...
  resulterrbound = (3.f + 8.f * epsilon) * epsilon;
  ccwerrboundA = (3.f + 16.f * epsilon) * epsilon;
  ccwerrboundB = (2.f + 12.f * epsilon) * epsilon;
  ccwerrboundC = (9.f + 64.f * epsilon) * epsilon * epsilon;
  o3derrboundA = (7.f + 56.f * epsilon) * epsilon;
  o3derrboundB = (3.f + 28.f * epsilon) * epsilon;
  o3derrboundC = (26.f + 288.f * epsilon) * epsilon * epsilon;
  iccerrboundA = (10.f + 96.f * epsilon) * epsilon;
  iccerrboundB = (4.f + 48.f * epsilon) * epsilon;
  iccerrboundC = (44.f + 576.f * epsilon) * epsilon * epsilon;
  isperrboundA = (16.f + 224.f * epsilon) * epsilon;
  isperrboundB = (5.f + 72.f * epsilon) * epsilon;
  isperrboundC = (71.f + 1408.f * epsilon) * epsilon * epsilon;
}
