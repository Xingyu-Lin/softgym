...
public:
	...
	FlagCloth()
	{
		...
		float bendStiffness = 0.005f;
		float shearStiffness = 0.001f;
		...
		*/
		...
		int phase = NvFlexMakePhase(0, 0);// eNvFlexPhaseSelfCollide | eNvFlexPhaseSelfCollideFilter);
	
		CreateSpringGrid(Vec3(0.0f, 30.0f, -3.0f), dimx, dimz, 1, radius, phase, stretchStiffness, bendStiffness, shearStiffness, 0.0f, 1.0f);
