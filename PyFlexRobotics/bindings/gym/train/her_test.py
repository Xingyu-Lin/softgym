...
def train(policy, evaluator,
          n_epochs, n_test_rollouts, n_cycles, n_batches, policy_save_interval,
          save_policies, resume_episode, **kwargs):
    ...
    logger.info("Testing...")
    best_success_rate = -1
    for epoch in range(resume_episode, n_epochs):
        # train
...
def launch(cfg_env, cfg_train, logdir, save_policies=True, override_params={}):
    ...
    resume_episode=cfg_train['learn']['resume']
    resume_path = os.path.join(logdir, 'policy_{}.pkl').format(resume_episode)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_env', type=str, default='cfg/fetch_reach_multigoal.yaml')
